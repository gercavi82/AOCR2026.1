    ...
    try {
        ...
        Swal.fire({
            ...
            html: `<div class="text-left">
                ...
                <p><strong>Operador:</strong> ${AOCR.escapeHtml(String(valores.operadorDefecto))}</p>
                <p><strong>Email:</strong> ${AOCR.escapeHtml(String(valores.emailDefecto))}</p>
                <p><strong>RUC:</strong> ${AOCR.escapeHtml(String(valores.rucDefecto))}</p>
                <p><strong>Cache:</strong> ${AOCR.escapeHtml(window.AOCRConfig.lastUpdated ? 'Activo' : 'No')}</p>
        ...
        Swal.fire({
            ...
            text: 'No se pudieron cargar los valores configurables: ' + AOCR.escapeHtml(String(error && error.message ? error.message : '')),
            icon: 'error',
            confirmButtonText: 'OK'
        });
    }
