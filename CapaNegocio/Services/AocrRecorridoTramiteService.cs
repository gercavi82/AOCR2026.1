...
namespace CapaNegocio.Services
{
    public class AocrRecorridoTramiteService
    {
        ...
        private static readonly string[] StandardStateSequence = new[]
        {
            ...
            AocrEstadosProceso.InformeTecnicoFirmado,
            AocrEstadosProceso.InformeEnviadoDireccion,
            AocrEstadosProceso.InformeAprobadoDireccion,
            AocrEstadosProceso.AocrDatosCompletos,
            AocrEstadosProceso.AocrPdfGenerado,
            AocrEstadosProceso.AocrFirmado,
            AocrEstadosProceso.CondicionesPdfGenerado,
            AocrEstadosProceso.CondicionesFirmadas,
