...
-- 4. Este script NO hace COMMIT automatico. Por defecto termina en ROLLBACK para ejecucion segura.
-- 4.1. Si ya confirmo el respaldo y quiere aplicar la limpieza real, use scripts/db/aocr_operational_cleanup_commit.sql.
...
-- CAMBIE ROLLBACK POR COMMIT SOLO DESPUES DE:
-- 1. Confirmar que los conteos DESPUES son cero para las tablas objetivo.
-- 2. Ejecutar scripts/db/aocr_post_cleanup_verify.sql.
-- 3. Verificar login, menus, usuarios y parametros en la aplicacion.
