...
### Integracion OR con politica compartida

- `OrdenRecaudacionCorreoService` ahora usa la misma politica de destinatarios compartida.
- El orquestador de OR ya no arma destinatarios ni cuerpo final por su cuenta para notificaciones estandar.
- El envio de orden generada con PDF adjunto desde `OrdenRecaudacionController` tambien pasa por cola y por la misma politica.
