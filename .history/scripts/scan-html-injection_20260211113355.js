  ...
  for (const e of entries) {
    ...
    patterns.forEach(p => {
      ...
      while ((m = re.exec(text)) !== null) {
        ...
        const safeIndicators = ['AOCR.escapeHtml', 'AOCR.escapeAttr', 'escapeHtml(', 'escapeAttr(', 'HttpUtility.HtmlEncode', 'Html.Encode(', 'HtmlEncode(', '.text(', 'append(AOCR.createOption', '<option'];
