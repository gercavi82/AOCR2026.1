...
$tareasPendientes = @(
    "Actualizar Controller a async (ver PLAN_REPARACION línea ~200)",
    "Configurar DI en App_Start/UnityConfig.cs (ver PLAN_REPARACION línea ~280)",
    ...
    "Commit cambios: git commit -m 'Fix críticos OrdenRecaudacion'",
    "Deploy a QA para validación"
)
