...
|---|---------|-----------|--------------|--------|
| P1.1 | `scripts/sql/*.sql` | Actualizar scripts desactualizados para usar nombres en inglés que coincidan con la base de datos real | Ejecutar scripts y comparar con `\d email_queue` | PENDIENTE |
