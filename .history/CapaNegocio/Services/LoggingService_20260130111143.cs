...
namespace CapaNegocio.Services
{
    ...
    public class LoggingService : ILoggingService
    {
        ...
        {
            return HttpContext.Current?.Items["CorrelationId"] as string;
        }
        ...
        private class LogScope : IDisposable
        {
            ...
            public LogScope(LogContext context)
            {
                ...
                {
                    _previousCorrelationId = HttpContext.Current.Items["CorrelationId"] as string;

                    if (!string.IsNullOrEmpty(context.CorrelationId))
                    {
                        HttpContext.Current.Items["CorrelationId"] = context.CorrelationId;
                    }
                    if (!string.IsNullOrEmpty(context.NumeroOrden))
                    {
                        HttpContext.Current.Items["NumeroOrden"] = context.NumeroOrden;
                    }
                    if (!string.IsNullOrEmpty(context.CodigoSolicitud))
                    {
                        HttpContext.Current.Items["CodigoSolicitud"] = context.CodigoSolicitud;
                    }
                }
            }
            ...
            public void Dispose()
            {
                ...
                {
                    HttpContext.Current.Items["CorrelationId"] = _previousCorrelationId;
                }
            }
        }
    }
