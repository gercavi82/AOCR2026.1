    ...
    public class FirmaDigitalService
    {
        ...
        private static Rectangle ObtenerRectanguloFirmaPersonalizado(PdfReader reader, int numeroPagina, string rolFirmante, PosicionFirmaVisualPdf posicionFirmaVisual)
        {
            if (reader != null && posicionFirmaVisual != null && posicionFirmaVisual.EsValida)
            {
                ...
                var width = Limitar(pageWidth * posicionFirmaVisual.AnchoRatio, 72f, pageWidth * 0.45f);
                var height = Limitar(pageHeight * posicionFirmaVisual.AltoRatio, 36f, pageHeight * 0.18f);
                var left = Limitar(pageWidth * posicionFirmaVisual.PosicionXRatio, 18f, pageWidth - width - 18f);
                var top = Limitar(pageHeight * (1f - posicionFirmaVisual.PosicionYRatio), height + 18f, pageHeight - 18f);
