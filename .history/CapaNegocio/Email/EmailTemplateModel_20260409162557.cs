...
{
    /// <summary>
    /// Modelo unificado para construir cualquier correo del sistema AOCR
    /// con la plantilla institucional estandarizada.
    /// </summary>
    public class EmailTemplateModel
    {
        ...
        /// <summary>
        /// Contenido HTML libre que se inserta después del resumen y antes del cierre.
        /// Usar solo cuando el bloque estándar de resumen no es suficiente
