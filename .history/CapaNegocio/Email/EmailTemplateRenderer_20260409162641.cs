...
{
    /// <summary>
    /// Renderiza la plantilla HTML institucional unificada para todos los correos AOCR.
    /// Genera HTML con estilos inline compatibles con Outlook, Gmail, Yahoo y correo movil.
    /// </summary>
    public static class EmailTemplateRenderer
    {
        /// <summary>
        /// Genera el HTML completo del correo a partir del modelo unificado.
        /// </summary>
...
");
            ...
            if (!string.IsNullOrWhiteSpace(model.EnlaceUrl))
            {
                ...
                sb.Append(EncodeAttribute(model.EnlaceUrl));
