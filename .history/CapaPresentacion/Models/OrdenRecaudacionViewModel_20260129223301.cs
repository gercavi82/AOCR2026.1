...
namespace CapaPresentacion.Models
{
    ...
    public static class EstadoOrdenHelper
    {
        ...
        public static string ObtenerClaseBadge(EstadoOrden estado)
        {
            switch (estado)
            {
                case EstadoOrden.Borrador: return "badge-secondary";
                case EstadoOrden.Generada: return "badge-info";
                case EstadoOrden.Enviada: return "badge-warning";
                case EstadoOrden.Pagada: return "badge-success";
                case EstadoOrden.Anulada: return "badge-danger";
