...
namespace CapaPresentacion.Controllers
{
    ...
    public class OrdenRecaudacionController : Controller
    {
        ...
        {
            // Usar OrdenRecaudacionNuevaVM que es lo que espera la vista
            var model = new OrdenRecaudacionNuevaVM
            {
            ...
            // Cargar lista de conceptos para el dropdown
            CargarConceptos();
        ...
        public ActionResult Nueva(OrdenRecaudacionNuevaVM model)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    int nuevoId = GuardarOrdenNueva(model);
        ...
        private void CargarConceptos()
        {
            ...
            ViewBag.Conceptos = new SelectList(new List<SelectListItem>
            {
                new SelectListItem { Value = "1", Text = "Concepto 1" },
                new SelectListItem { Value = "2", Text = "Concepto 2" },
                new SelectListItem { Value = "3", Text = "Concepto 3" }
            }, "Value", "Text");
        }

        private int GuardarOrdenNueva(OrdenRecaudacionNuevaVM model)
        {
            // TODO: Implementar guardado en capa de negocio
            return 1;
        }
