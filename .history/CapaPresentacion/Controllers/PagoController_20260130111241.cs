...
namespace CapaPresentacion.Controllers
{
    ...
    public class PagoController : Controller
    {
        ...
        public async Task<ActionResult> Validar(ValidarPagoViewModel model)
        {
            ...
            using (_logger.BeginScope(new LogContext { CorrelationId = correlationId }))
            {
                try
                {
                    ...
                    if (resultado.Success)
                    {
                        ...
                        _logger.LogInfo(mensaje, new LogContext { CorrelationId = correlationId });
                ...
                {
                    _logger.LogError(ex, new LogContext { CorrelationId = correlationId });
