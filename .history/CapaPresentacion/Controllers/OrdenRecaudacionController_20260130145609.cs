...
namespace CapaPresentacion.Controllers
{
    ...
    public class OrdenRecaudacionController : Controller
    {
        ...
        private async Task CargarViewBagsParaNueva()
        {
            ...
            {
                ViewBag.Conceptos = new List<ConceptoModel>();
            }
        ...
        // Agregar este método helper dentro de la clase:
        private void EnviarNotificacionAFinanciero(OrdenRecaudacion orden, PagoModel pago, string emailFinanciero, string comprobanteRuta)
        {
            try
            {
