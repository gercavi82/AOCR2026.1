...
namespace CapaPresentacion.Controllers
{
    ...
    public class OrdenRecaudacionController : Controller
    {
        ...
        public ActionResult DiagnosticoSesion()
        {
            ...
            diagnostico.AppendLine($"\nTodos los roles: {string.Join(", ", principal?.Roles ?? new string[0])}");
        ...
        public ActionResult Nueva()
        {
            ...
            try
            {
                ...
                System.IO.File.AppendAllText(logPath, $"Roles: {string.Join(",", (User as System.Security.Principal.GenericPrincipal)?.Roles ?? new string[0])}\n");
