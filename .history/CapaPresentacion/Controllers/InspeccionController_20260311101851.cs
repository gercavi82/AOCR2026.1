...
namespace CapaPresentacion.Controllers
{
    ...
    public class InspeccionController : Controller
    {
        ...
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult GuardarInformeTecnico(int id, string titulo, string resumen, string resultado, string observaciones, string conclusiones, string recomendaciones, bool finalizar = false)
        {
            try
            {
                if (id <= 0)
                ...
                TempData["Success"] = correoEnviado
                    ...
                    : "Informe técnico finalizado y PDF generado. No se pudo enviar el correo al solicititante.";
        ...
        private string GuardarInformeTecnicoPdf(int codigoInspeccion, int version, byte[] pdfBytes)
        {
            ...
            return CARPETA_VIRTUAL_INFORMES_TECNICOS + "/" + fileName;
        }
