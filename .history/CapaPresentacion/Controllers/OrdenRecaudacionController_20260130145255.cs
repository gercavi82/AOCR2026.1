...
namespace CapaPresentacion.Controllers
{
    ...
    public class OrdenRecaudacionController : Controller
    {
        ...
        private readonly OrdenRecaudacionBL _bl;
        ...
        public OrdenRecaudacionController()
        {
            ...
            _bl = new OrdenRecaudacionBL();
            _conceptoDao = new ConceptoDAO();
            _solicitudDao = new SolicitudAOCRDAO();
        }

        public OrdenRecaudacionController(IOrdenRecaudacionOrchestrator orchestrator) : this()
        {
        ...
        public JsonResult Anular(int id)
        {
            ...
            try
            {
                bool result = _dao.CambiarEstadoOrden(id, "ANULADA"); // Sin tercer parámetro
        ...
        public ActionResult RegistrarPago(int id, string Monto, string NumeroFactura, string MetodoPago, HttpPostedFileBase ComprobanteArchivo, string Observaciones)
        {
            ...
            try
            {
                ...
                string pagoErr;
                bool pagoOk = _dao.RegistrarPago(id, pago, out pagoErr);
                if (!pagoOk)
                {
        ...
        {
            ViewBag.Conceptos = _conceptoDao.ObtenerConceptos(true) ?? new List<ConceptoModel>();
            ViewBag.Contribuyentes = new List<object>(); // Placeholder
        }
    }
}
