        ...
        public ActionResult DescargarPdf(int id)
        {
            ...
            try
            {
                ...
                var pdfModel = new CapaPresentacion.Models.ViewModels.OrdenRecaudacionPDFModel
                {
                    ...
                    ValorBase = ordenModel.Subtotal ?? 3380.00m,
                    Estaciones = 1, // Este valor debería venir de los datos de la solicitud
                    Dias = 1, // Este valor debería venir de los datos de la solicitud  
