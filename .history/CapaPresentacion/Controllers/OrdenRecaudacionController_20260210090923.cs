    ...
    public class OrdenRecaudacionController : Controller
    {
        ...
        private async Task EnviarNotificacionOrdenGeneradaAsync(OrdenRecaudacionModel orden)
        {
            try
            {
                ...
                pdfModel.LeyendaBancos = "Puede realizar el pago en los siguientes bancos autorizados: " + string.Join(", ", bancos.Select(b => b.Descripcion));
                ...
                servicioCorreo.enviaMensajeCorreoConAdjunto(emailDestino, asunto, cuerpo, pdfBytes, nombreArchivo, "application/pdf");
            }
            catch (Exception ex)
            {
