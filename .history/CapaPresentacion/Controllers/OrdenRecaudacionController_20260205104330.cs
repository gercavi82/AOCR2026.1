...
namespace CapaPresentacion.Controllers
{
    ...
    public class OrdenRecaudacionController : Controller
    {
        ...
        public ActionResult DescargarPdf(int id)
        {
            ...
            try
            {
                // Crear modelo PDF con valores dinámicos de la base de datos
                var pdfModel = new CapaPresentacion.Models.ViewModels.OrdenRecaudacionPDFModel
                {
                    NumeroOrden = ordenModel.NumeroOrden,
                    FechaEmision = ordenModel.FechaCreacion.HasValue ? ordenModel.FechaCreacion.Value : DateTime.Now,
                    LugarEmision = "Quito",
                    NombreCompania = ordenModel.NombreContribuyente,
                    Ruc = ordenModel.NombreContribuyente ?? "No especificado",
                    Email = "info@dgac.gob.ec",
                    Telefono = ordenModel.Telefono ?? "No especificado",
                    ConceptoPrincipal = "Inspección y Certificación AOCR",
                    ValorBase = ordenModel.Subtotal.HasValue ? ordenModel.Subtotal.Value : 0m, // Sin valores hardcodeados
                    Estaciones = 1, // TODO: obtener de los datos reales de la solicitud
                    Dias = 1, // TODO: obtener de los datos reales de la solicitud  
