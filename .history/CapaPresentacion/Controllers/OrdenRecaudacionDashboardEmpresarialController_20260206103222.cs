    ...
    public class OrdenRecaudacionDashboardEmpresarialController : Controller
    {
        ...
        public JsonResult CambiarEstado(int id, string nuevoEstado, string observacion = null)
        {
            try
            {
                ...
                // Nota: Usar la propiedad correcta para verificar si tiene detalles
                var tieneDetalles = true; // Por defecto asumir que tiene detalles, ajustar según la entidad real
        ...
        private int ObtenerIdUsuario()
        {
            try
            {
                var sessionId = Session["CodigoUsuario"];
