...
namespace CapaPresentacion.Controllers
{
    ...
    public class OrdenRecaudacionController : Controller
    {
        ...
        public ActionResult Nueva()
        {
            try
            {
                System.Diagnostics.Debug.WriteLine("=== OrdenRecaudacion.Nueva() INICIADO ===");
                var model = new CapaPresentacion.Models.OrdenRecaudacionNuevaVM();
                System.Diagnostics.Debug.WriteLine("Modelo creado, llamando a CargarConceptosNueva...");
                CargarConceptosNueva(model);
                System.Diagnostics.Debug.WriteLine("CargarConceptosNueva completado, retornando vista");
                return View(model);
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine("*** ERROR EN Nueva(): " + ex.ToString());
