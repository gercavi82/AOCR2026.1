...
namespace CapaPresentacion.Controllers
{
    ...
    public class OrdenRecaudacionController : Controller
    {
        ...
        // GET: /OrdenRecaudacion/ExportarExcel
        [Authorize(Roles = "Solicitante,Administrador,Financiero")]
        public ActionResult ExportarExcel(string estado)
        {
            int idUsuario = GetUserId();
            if (idUsuario <= 0) return RedirectToAction("Login", "Account");
            ...
            // TODO: Implementar excel real (ClosedXML) según tu proyecto.
            // Por ahora: retorno vista/placeholder para no inventar.
            return View("ExportarExcel", ordenes);
        }
