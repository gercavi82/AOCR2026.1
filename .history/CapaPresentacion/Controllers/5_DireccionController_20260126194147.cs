...
namespace CapaPresentacion.Controllers
{
    public class DireccionController : Controller
    {
        ...
        {
            var solicitudesPendientes = new SolicitudAOCRBL().ListarPorEstado("VALIDADO_TECNICAMENTE");
        ...
        public ActionResult ValidacionFinal(int id, bool aprobada, string observaciones, string condicionesEspeciales, int vigencia)
        {
            try
            {
                ...
                if (aprobada)
                {
                    ...
                    new SolicitudAOCRBL().CambiarEstado(id, "APROBADO_POR_DIRECCION", User.Identity.Name, observaciones ?? "Aprobado por Dirección");
                ...
                {
                    // Rechazar solicitud
                    new SolicitudAOCRBL().CambiarEstado(id, "RECHAZADO_POR_DIRECCION", User.Identity.Name, observaciones ?? "Rechazado por Dirección");
        ...
        public ActionResult Legalizar(int id, string firmaDirector, string selloOficial)
        {
            try
            {
                ...
                new SolicitudAOCRBL().CambiarEstado(id, "LEGALIZADO", User.Identity.Name, "Certificado legalizado y firmado");
        ...
        public ActionResult EmitirAOCR(int id)
        {
            try
            {
                ...
                new SolicitudAOCRBL().CambiarEstado(id, "CERTIFICADO_EMITIDO", User.Identity.Name, "Certificado AOCR emitido");
