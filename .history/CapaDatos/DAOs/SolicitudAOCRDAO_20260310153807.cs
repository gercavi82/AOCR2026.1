                ...
                using (var cn = new NpgsqlConnection(ConnectionString))
                {
                    ...
                    using (var tx = cn.BeginTransaction())
                    {
                        ...
                        using (var cmdSolicitud = new NpgsqlCommand(sqlSolicitud, cn, tx))
                        {
                            ...
                            cmdSolicitud.Parameters.AddWithValue("@updated_by", (object)principalCedulaPersist ?? DBNull.Value);
                        ...
                        using (var cmdIns = new NpgsqlCommand(sqlInsertInspeccion, cn, tx))
                        {
                            ...
                            cmdIns.Parameters.AddWithValue("@created_by", (object)principalCedulaPersist ?? DBNull.Value);
                            cmdIns.Parameters.AddWithValue("@updated_by_ins", (object)principalCedulaPersist ?? DBNull.Value);
