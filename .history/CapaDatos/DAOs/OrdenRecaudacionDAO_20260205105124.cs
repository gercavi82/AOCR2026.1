        ...
        public List<OrdenRecaudacion> ObtenerTodas()
        {
            ...
            try
            {
                using (var conn = new NpgsqlConnection(_connectionString))
                {
                    ...
                    System.Diagnostics.Debug.WriteLine($"OrdenRecaudacionDAO.ObtenerTodas: Ejecutando consulta: {sql}");
                    ...
                    using (var reader = cmd.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            System.Diagnostics.Debug.WriteLine($"OrdenRecaudacionDAO.ObtenerTodas: Procesando orden #{contador} - numero_orden = {numeroOrden}");
                            ordenes.Add(MapearOrden(reader));
                        }
                        System.Diagnostics.Debug.WriteLine($"OrdenRecaudacionDAO.ObtenerTodas: Total de órdenes procesadas: {contador}");
                    }
                }
            }
            catch (Exception ex)
