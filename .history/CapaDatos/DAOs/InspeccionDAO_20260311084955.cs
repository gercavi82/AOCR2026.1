...
namespace CapaDatos.DAOs
{
    public class InspeccionDAO
    {
        ...
        public Inspeccion ObtenerPorId(int id)
        {
            const string sql = @"
                SELECT i.*,
                       s.codigo_tecnico AS solicitud_codigo_tecnico,
                       s.tecnico_responsable_cedula AS solicitud_inspector_principal_cedula,
                       s.tecnico_responsable_nombre AS solicitud_inspector_principal_nombre,
                       s.tecnico_responsable_tipo AS solicitud_inspector_principal_tipo,
                       s.inspector_apoyo_cedula AS solicitud_inspector_apoyo_cedula,
                       s.inspector_apoyo_nombre AS solicitud_inspector_apoyo_nombre,
                       s.inspector_apoyo_tipo AS solicitud_inspector_apoyo_tipo
