        ...
        public void CalcularTotales()
        {
            ...
            else
            {
                ...
                catch (Exception)
                {
                    ...
                    try
                    {
                        // Intentar obtener desde configuración alternativa
                        var parametroDAO = new ParametroDAO();
                        var porcentajeDefault = parametroDAO.SafeGetColumn<decimal>("parameters", "param_value", "param_name = 'CALCULO_PORCENTAJE_GASTOS_ADMIN'", 8.0m);
