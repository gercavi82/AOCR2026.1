    ...
    public class EmpresaAS400DAO
    {
        ...
        private string BuildConnectionString(AS400Credentials creds)
        {
            ...
            return string.Format(
                "Driver={{IBM i Access ODBC Driver}};System={0};DefaultCollection={1};Uid={2};Pwd={3};",
                creds.Server,
                defaultCollection,
                creds.UserId,
                creds.Password);
        ...
        public List<Empresa> ObtenerEmpresas()
        {
            ...
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    System.Diagnostics.Debug.WriteLine($"🔗 [EmpresaAS400DAO] Connection String: {conn.ConnectionString.Replace("Pwd=", "Pwd=***")}");
