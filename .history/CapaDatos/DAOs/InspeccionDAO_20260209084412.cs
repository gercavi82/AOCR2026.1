    ...
    public class InspeccionDAO
    {
        ...
        public int Crear(Inspeccion i)
        {
            const string sql = @"
                ...
                (codigo_solicitud, codigo_inspector, fecha_programada, hora_programada, duracion_estimada,
        ...
        private Inspeccion Map(IDataRecord dr)
        {
            ...
            return new Inspeccion
            {
                ...
                HoraProgramada = dr["hora_programada"] != DBNull.Value ? (TimeSpan?)dr["hora_programada"] : null,
