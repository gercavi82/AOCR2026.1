            ...
            using (var cn = new NpgsqlConnection(ConnectionString))
            {
                ...
                string sql = @"
                    ...
                    SELECT
                        ...
                        NOW(),
                        'SYSTEM'
                    FROM aocr_tbchecklist_item ci
                    WHERE ci.descripcion = @Descripcion
                ...
                using (var cmd = new NpgsqlCommand(sql, cn))
                {
                    ...
                    if (filas == 0)
                    {
                        throw new InvalidOperationException("No se encontro el item de checklist en aocr_tbchecklist_item para la descripcion proporcionada.");
                    }
                }
            }
        }
