...
namespace CapaDatos.DAOs
{
    ...
    public class ParametroDAO
    {
        ...
        private Parametro MapParametro(IDataRecord r)
        {
            ...
            {
                CodigoParametro = r["codigo_parametro"] != DBNull.Value ? Convert.ToInt32(r["codigo_parametro"]) : 0,
                ...
                CodigoParametroStr = r["codigoparametro"]?.ToString(),
                ValorParametro = r["valorparametro"] != DBNull.Value ? (decimal?)Convert.ToDecimal(r["valorparametro"]) : null,
                DescripcionParametro = r["descripcionparametro"]?.ToString(),
                ActivoNuevo = r["activo"] != DBNull.Value ? (bool?)Convert.ToBoolean(r["activo"]) : null,
                CreatedAtNuevo = r["createdat"] != DBNull.Value ? (DateTime?)Convert.ToDateTime(r["createdat"]) : null,
                UpdatedAtNuevo = r["updatedat"] != DBNull.Value ? (DateTime?)Convert.ToDateTime(r["updatedat"]) : null,
                CreatedByStr = r["createdby"]?.ToString(),
                UpdatedByStr = r["updatedby"]?.ToString(),
                DeletedAtNuevo = r["deletedat"] != DBNull.Value ? (DateTime?)Convert.ToDateTime(r["deletedat"]) : null,
                DeletedByStr = r["deletedby"]?.ToString(),

                // Columnas legacy (compatibilidad hacia atrás)
                CreatedAt = r["created_at"] != DBNull.Value ? (DateTime?)Convert.ToDateTime(r["created_at"]) : null,
                CreatedBy = r["created_by"] != DBNull.Value ? (int?)Convert.ToInt32(r["created_by"]) : null,
                UpdatedAt = r["updated_at"] != DBNull.Value ? (DateTime?)Convert.ToDateTime(r["updated_at"]) : null,
                UpdatedBy = r["updated_by"] != DBNull.Value ? (int?)Convert.ToInt32(r["updated_by"]) : null,
