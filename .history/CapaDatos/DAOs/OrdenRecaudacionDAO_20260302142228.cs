                ...
                using (var conn = new NpgsqlConnection(_connectionString))
                {
                    ...
                    using (var tx = conn.BeginTransaction())
                    {
                        ...
                        using (var cmdFactura = new NpgsqlCommand(sqlUpdateFactura, conn, tx))
                        {
                            ...
                            cmdFactura.Parameters.AddWithValue("@fr3_numero", (object)fr3Numero ?? DBNull.Value);
                            cmdFactura.Parameters.AddWithValue("@fr3_secuencial", fr3Secuencial);
                            cmdFactura.Parameters.AddWithValue("@fr3_aeropuerto", (object)fr3Aeropuerto ?? DBNull.Value);
                            cmdFactura.Parameters.AddWithValue("@fr3_anio", (object)fr3Anio ?? DBNull.Value);
                            cmdFactura.Parameters.AddWithValue("@fr3_error", (object)detalleError ?? DBNull.Value);
                            ...
                            var paramPagoId = new NpgsqlParameter("@pago_id", NpgsqlTypes.NpgsqlDbType.Integer);
                            paramPagoId.Value = pagoId.HasValue ? (object)pagoId.Value : DBNull.Value;
                            cmdFactura.Parameters.Add(paramPagoId);
                        ...
                        using (var cmdSync = new NpgsqlCommand(sqlSyncLog, conn, tx))
                        {
                            ...
                            var paramSyncPagoId = new NpgsqlParameter("@pago_id", NpgsqlTypes.NpgsqlDbType.Integer);
                            paramSyncPagoId.Value = pagoId.HasValue ? (object)pagoId.Value : DBNull.Value;
                            cmdSync.Parameters.Add(paramSyncPagoId);
                            ...
                            cmdSync.Parameters.AddWithValue("@fr3_numero", (object)fr3Numero ?? DBNull.Value);
