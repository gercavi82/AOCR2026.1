...
namespace CapaDatos.DAOs
{
    ...
    public class OrdenRecaudacionDAO : BaseDAO, IOrdenRecaudacionRepository
    {
        ...
        public bool ExisteSolicitud(int id) => false;
        ...
        public int ObtenerCodigoSolicitudPorNumero(string numero) => 0;
        public int ObtenerCodigoSolicitudPorRuc(string ruc) => 0;
        public bool ActualizarCodigoSolicitudOrden(int id, int codigo) => true;
