    ...
    public class OrdenRecaudacionDAO : IOrdenRecaudacionRepository, IOrdenRecaudacionDAO
    {
        ...
        private OrdenRecaudacion MapearOrden(IDataReader reader)
        {
            var orden = new OrdenRecaudacion
            {
                ...
                CodigoUsuario = reader.IsDBNull(reader.GetOrdinal("codigo_usuario")) ? (int?)null : ParseIntOrDefault(reader.GetString(reader.GetOrdinal("codigo_usuario"))),
                CodigoSolicitud = reader.IsDBNull(reader.GetOrdinal("codigo_solicitud")) ? (int?)null : ParseIntOrDefault(reader.GetString(reader.GetOrdinal("codigo_solicitud"))),
