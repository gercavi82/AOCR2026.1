...
namespace CapaDatos.Constants
{
    ...
    public static class EstadoSolicitud
    {
        ...
        /// <summary>
        /// Verifica si el estado permite edición de la solicitud
        /// </summary>
        /// <param name="estado">Estado a verificar</param>
        /// <returns>True si permite edición, False en caso contrario</returns>
        public static bool PermiteEdicion(string estado)
        {
            if (string.IsNullOrEmpty(estado))
                return false;
                
            return estado.Equals(BORRADOR, StringComparison.OrdinalIgnoreCase) ||
                   estado.Equals(DEVUELTO, StringComparison.OrdinalIgnoreCase) ||
                   estado.Equals(OBSERVADO, StringComparison.OrdinalIgnoreCase);
        }
    }
}
