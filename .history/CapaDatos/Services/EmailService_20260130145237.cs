...
namespace CapaDatos.Services
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public void EnviarNotificacionFinanciero(object orden, object pago, string emailFinanciero, string comprobanteRuta)
        {
            try
            {
                var asunto = "Nueva orden pendiente de revisión";
                var cuerpo = "Se ha registrado un nuevo pago que requiere su revisión.";
                EnviarAsync(emailFinanciero, "Financiero", asunto, cuerpo, null, null).Wait();
            }
            catch (Exception ex)
            {
