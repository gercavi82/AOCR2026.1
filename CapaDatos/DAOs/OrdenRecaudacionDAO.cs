...
namespace CapaDatos.DAOs
{
    ...
    public class OrdenRecaudacionDAO : IOrdenRecaudacionRepository, IOrdenRecaudacionDAO
    {
        ...
        /// <summary>
        /// Crea la orden en estado GENERADA, inserta detalles y encola correo de confirmaci�n
        /// en una sola transacci�n de base de datos.
        /// </summary>
            ...
            out string err)
        {
            ...
            {
                err = "No existe correo destino para la notificaci�n.";
                return false;
            }
