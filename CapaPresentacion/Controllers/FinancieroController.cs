...
namespace CapaPresentacion.Controllers
{
    ...
    public class FinancieroController : Controller
    {
        ...
        public ActionResult DescargarComprobante(int ordenId, int? pagoId)
        {
            ...
            {
                TempData["Error"] = "No se encontró comprobante para esta orden.";
            ...
            {
                TempData["Error"] = "El comprobante no está disponible.";
                return RedirectToAction("DetalleOrden", new { id = ordenId });
            }
        ...
        public ActionResult AprobarOrden(int id, HttpPostedFileBase facturaArchivo, string observacionesCorreo, string correoDestino)
        {
            ...
            try
            {
                ...
                TempData["Success"] = "Orden aprobada. Correo encolado para envío.";
            }
        ...
        public ActionResult AprobarPago(int id, int? pagoId, HttpPostedFileBase facturaArchivo, string observacionesCorreo, string correoDestino)
        {
            ...
            try
            {
                ...
                TempData["Success"] = "Pago aprobado. Correo encolado para envío.";
            }
            catch (System.Exception ex)
            {
        ...
        public ActionResult RechazarOrden(int id, string motivo)
        {
            ...
            try
            {
                ...
                TempData["Success"] = "Orden rechazada correctamente. Correo encolado para envío.";
            }
            catch (System.Exception ex)
            {
        ...
        public ActionResult ReenviarFactura(int id, string correoDestino, string observacionesCorreo)
        {
            ...
            try
            {
                ...
                {
                    TempData["Error"] = "No se pudo encolar el correo de reenvío: " + errorCorreo;
                    return RedirectToAction("DetalleOrden", new { id = id });
                }

                TempData["Success"] = "Factura reenviada. Correo encolado para envío.";
            }
            catch (Exception ex)
            {
            ...
            out string error)
        {
            ...
            {
                error = "No hay destinatarios válidos. Ingrese un correo destino o registre el correo del contribuyente.";
                CapaNegocio.LogBL.RegistrarError($"No hay destinatarios válidos para factura. Orden={orden?.NumeroOrden}", $"correoDestino={correoDestino}; contribuyente={orden?.EmailContribuyente}", "FinancieroController");
                return false;
            }

            if (string.IsNullOrWhiteSpace(facturaRutaFisica) || !System.IO.File.Exists(facturaRutaFisica))
            {
                error = "No se encontró la factura para adjuntar.";
                return false;
            }
            ...
            out string error)
        {
            ...
            if (destinatarios.Count == 0)
            {
                error = "No hay destinatarios válidos para notificar el rechazo.";
                return false;
            }
            ...
            string correlationId)
        {
            ...
            {
                CapaNegocio.LogBL.RegistrarError("Error registrando auditoría financiera", ex.ToString(), "FinancieroController");
            }
        }
