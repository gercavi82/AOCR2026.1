(function (window, document) {
    ...
    function setWorker() {
        ...
        if (pdfjs && pdfjs.GlobalWorkerOptions && !pdfjs.GlobalWorkerOptions.workerSrc) {
            pdfjs.GlobalWorkerOptions.workerSrc = window.AOCR_PDF_WORKER_URL || '/Content/aocr-pdf-viewer/pdf.worker.min.js';
        }
    }
    ...
    Viewer.prototype.handle = function (action) {
        ...
        if (action === 'reload') this.load(this.pdfUrl);
