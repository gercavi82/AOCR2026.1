        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (ordenesPorSolicitud.Count > 0)
                {
                    ...
                    string info = "   Primera orden para solicitud 1 - ";
                    if (primera != null)
                    {
                        info += "ID: " + primera.Id + ", Estado: " + primera.Estado;
                    }
                    else
                    {
                        info += "null";
                ...
                if (todasOrdenes.Count > 0)
                {
                    ...
                    string info = "   Muestra - ID: " + muestra.Id;
                    if (muestra.CodigoSolicitud.HasValue)
                    {
                        info += ", Código Solicitud: " + muestra.CodigoSolicitud.Value;
                    }
                    else
                    {
                        info += ", Código Solicitud: null";
                    }
                    info += ", Estado: " + muestra.Estado;
                    Console.WriteLine(info);
                }
                Console.WriteLine();
